...
(function() {
    ...
    e = function() {
            function e(e, t) {
                var n, r;
                this.options = { target: "instafeed", get: "popular", resolution: "low_resolution", sortBy: "none", links: !0, mock: !1, useHttp: !1 };
                if (typeof e == "object")
                ...
                if (typeof document != "undefined" && document !== null && this.options.mock === !1) {
                    ...
                    if (this.options.template != null && typeof this.options.template == "string") {
                        ...
                        for (T = 0, k = m.length; T < k; T++) {
                            ...
                            if (typeof p != "object") throw o = "No image found for resolution: " + this.options.resolution + ".", new Error(o);
                            v = p.url, l = window.location.protocol.indexOf("http") >= 0, l && !this.options.useHttp && (v = v.replace(/https?:\/\//, "//")), g.src = v, this.options.links === !0 ? (t = document.createElement("a"), t.setAttribute("target", "_blank"), t.href = h.link, t.appendChild(g), u.appendChild(t)) : u.appendChild(g)
                        }
